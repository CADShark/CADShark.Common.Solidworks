...
namespace CADShark.Common.SolidWorks.Documents;
...
public enum OpenDocumentOptions
{
    ...
    /// </summary>
    [Obsolete] AutoMissingConfiguration = 32,
    ...
    /// <see cref="AssemblyDocument.OpenFile(string,OpenDocumentOptions,string)"/>, set <see cref="LoadLightweight"/>. 
    /// 
